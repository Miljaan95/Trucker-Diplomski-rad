...
namespace AppDemo.Services
{
    public class UserService : IUserService
    {
        ...
        public RegistrationStatus Register(RegisterModel model)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(model.Password))
                    return RegistrationStatus.PasswordRequired;
                else if (_context.Users.Any(x => x.Email.Equals(model.Email) || x.Username.Equals(model.Username)))
                    return RegistrationStatus.EmailOrUsernameRepeated;
                ...
                if(model.Role == UserRoles.Driver)
                {
